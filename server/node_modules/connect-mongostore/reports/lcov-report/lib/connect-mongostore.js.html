...
&nbsp;
    self.db.open(function (err, db) {
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (err) <span class="cstat-no"
                                                                                         title="statement not covered">throw new Error('Error connecting to database:\n' + err.message + '\n' + err.stack + '\n')</span>
&nbsp;
...
&nbsp;
    self.db.collection(self.collectionName, function (err, collection) {
      <span class="missing-if-branch" title="if path not taken"" >I</span>if (err) <span class="cstat-no"
                                                                                         title="statement not covered">throw new Error('Error getting collection: ' + self.collectionName + ' &lt;' + err + '&gt;')</span>
&nbsp;
      self.collection = collection
&nbsp;
      self.collection.ensureIndex({'expires': 1}, {'expireAfterSeconds': 0}, function (err, result) {
        <span class="missing-if-branch" title="if path not taken"" >I</span>if (err) <span class="cstat-no"
                                                                                           title="statement not covered">throw new Error('Error setting TTL index on collection : ' + self.collectionName + ' &lt;' + err + '&gt;')</span>
        cb &amp;&amp; cb(self.collection)
      })
    })
  }
...
&nbsp;
<span class="cstat-no" title="statement not covered">    opts.db.servers.forEach(<span class="fstat-no"
                                                                                       title="function not covered">function (server) {</span></span>
...
function dbFromMongooseConnection(mongooseConnection, opts) {
  <span class="missing-if-branch" title="if path not taken"" >I</span>if (mongooseConnection.user &amp;&amp; <span
        class="branch-1 cbranch-no" title="branch not covered">mongooseConnection.pass)</span> {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Thu May 01 2014
        14:37:31 GMT-0700 (PDT)
    </div>
</div>
